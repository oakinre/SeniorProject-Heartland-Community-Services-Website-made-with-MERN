            ...
            <FormWrap>
                <FormContent>
                    <Form className={classes.form} onSubmit={handleSubmit} isSignup={isSignup}>
                        <FormH1 color='#fff' fullWidth>Admin Account Creation Portal</FormH1>
                            ...
                            <Grid container spacing ={2}>
                                ...
                                <FormButton type='submit' className={classes.submit}> Create Admin </FormButton>
                    </Form>
                </FormContent>
            </FormWrap>
        </Container>
